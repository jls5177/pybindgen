...
def find_declaration_from_name(global_ns, declaration_name):
    decl = declarations.impl_details.find_value_type(global_ns, declaration_name)
    return decl
...
class ModuleParser(object):
    ...
    def parse_init(self, header_files, include_paths=None,
        ...
        :param gccxml_options: extra options to pass into the
            :class:`pygccxml.parser.config.xml_generator_configuration_t` object as keyword
        ...
        if include_paths is not None:
            ...
            warnings.warn("Parameter include_paths is deprecated, use gccxml_options instead", DeprecationWarning,
                          stacklevel=2)
            self.gccxml_config = parser.xml_generator_configuration_t(include_paths=include_paths, **gccxml_options)
        else:
            self.gccxml_config = parser.xml_generator_configuration_t(**gccxml_options)
